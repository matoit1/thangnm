<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TracNghiemTrucTuyen.Default" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblMsg" runat="server" ForeColor="Red"></asp:Label></center><br />
