...
namespace ThangNMjsc.Product
{
    class NL_Checkout
    {
        ...
        public String merchant_site_code = "29730";	//thay mã merchant site mà b?n dã dang ký vào dây
        public String secure_pass = "ThangNMjsc";	//thay m?t kh?u giao ti?p gi?a website c?a b?n v?i NgânLu?ng.vn mà b?n dã dang ký vào dây
