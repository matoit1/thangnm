<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Address.aspx.cs" Inherits="ThangNMjsc.Mobile.Info.Address" %>

<asp:Content ID="Content2" ContentPlaceHolderID="cphHead_Mobile" runat="server">
    <title>Bản đồ đường đi - Công ty Cổ phần ThangNM (Phiên bản Mobile)</title>
</asp:Content>
