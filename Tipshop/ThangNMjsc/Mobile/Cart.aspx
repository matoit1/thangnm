<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="ThangNMjsc.Mobile.Cart" MasterPageFile="~/Mobile/Mobile.Master"%>

<asp:Content ID="Content2" ContentPlaceHolderID="cphHead_Mobile" runat="server">
    <title>Giỏ hàng - Công ty Cổ phần ThangNM (Phiên bản Mobile)</title>
</asp:Content>
