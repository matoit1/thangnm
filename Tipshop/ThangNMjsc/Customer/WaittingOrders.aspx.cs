...
{
    public partial class WaittingOrders : System.Web.UI.Page
    {
        ...
        private void loadOrder()
        {
            try
            {
                DataTable dt = OrdersBO.getDataSetOrdersbyClient_ID(true, Request.Cookies["client"].Value).Tables[0];
        ...
        protected void grvListOrder_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                URL1.NavigateUrl = "~/Customer/OrdersDetails.aspx?Orders_ID=" + Orders_ID;
            }
        }
