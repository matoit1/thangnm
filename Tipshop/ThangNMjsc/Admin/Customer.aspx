<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="ThangNMjsc.Admin.Customer" MasterPageFile="~/MasterPage/PublicAdmin.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="cphMainContent_Admin" runat="server">
    ...
    <div>
        <center><asp:Label ID="Label8" runat="server" Text="Danh sách Khách hàng" CssClass="tieude"></asp:Label><br /><br />
        <asp:Label ID="Label13" runat="server" style="margin-left:50px"></asp:Label>
        </center>
        <cc1:GridViewExt ID="grvListCustomer" runat="server" CssClass="mGrid" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"
                ...
                WidthCheckBoxColumn="50" emptydatatext="Không có dữ liệu trả về."  onrowdatabound="grvListCustomer_RowDataBound" onpageindexchanging="grvListCustomer_PageIndexChanging">
        ...
        <asp:Button ID="btnNewCustomer" runat="server" Text="Thêm Khách hàng mới" PostBackUrl="~/Admin/Edit/EditAccounts.aspx" />
