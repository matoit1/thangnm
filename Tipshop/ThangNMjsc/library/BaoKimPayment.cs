...
class BaoKimPayment
{
    ...
    //Mã merchant site
    private string merchant_id = "10785";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

    //Mật khẩu bảo mật
    private string secure_pass = "22dda0d106133b38";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn
