<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tblErrorUI.aspx.cs" Inherits="Profile.tblErrorUI" %>
...
<AlternatingRowStyle CssClass="GridAlternatingItem"></AlternatingRowStyle>
	<Columns>
		...
		<asp:BoundField  DataField="PK_lErrorID"  HeaderText="PK_lErrorID" SortExpression="PK_lErrorID">
			<ItemStyle CssClass="GridItemNumber"/>
		</asp:BoundField>
		<asp:BoundField  DataField="sLink"  HeaderText="sLink" SortExpression="sLink">
			<ItemStyle CssClass="GridItemText"/>
		</asp:BoundField>
		<asp:BoundField  DataField="sIP"  HeaderText="sIP" SortExpression="sIP">
			<ItemStyle CssClass="GridItemText"/>
		</asp:BoundField>
		<asp:BoundField  DataField="sBrowser"  HeaderText="sBrowser" SortExpression="sBrowser">
			<ItemStyle CssClass="GridItemText"/>
		</asp:BoundField>
		<asp:BoundField  DataField="iCode"  HeaderText="iCode" SortExpression="iCode">
			<ItemStyle CssClass="GridItemNumber"/>
		</asp:BoundField>
		...
		<asp:BoundField  DataField="tTimeCheck"  HeaderText="tTimeCheck" SortExpression="tTimeCheck">
			<ItemStyle CssClass="GridItemDate"/>
		</asp:BoundField>
	</Columns>
	...
	<asp:View ID="vDetail" runat="server" ><asp:LinkButton ID="lbtnBack" runat="server" onclick="lbtnBack_Click">Quay lại danh sách</asp:LinkButton><br />	<table id="tblDetail" style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
		...
		<tr>
			<td class="name_field_row">PK_lErrorID:</td>
			<td class="field_row">
				<asp:TextBox id="txtPK_lErrorID" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lblPK_lErrorID" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
			<td class="name_field_row">sLink:</td>
			<td class="field_row">
				<asp:TextBox id="txtsLink" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lblsLink" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
			<td class="name_field_row">sIP:</td>
			<td class="field_row">
				<asp:TextBox id="txtsIP" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
		...
		<tr>
			<td class="name_field_row">sBrowser:</td>
			<td class="field_row">
				<asp:TextBox id="txtsBrowser" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lblsBrowser" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
			<td class="name_field_row">iCode:</td>
			<td class="field_row">
				<asp:TextBox id="txtiCode" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lbliCode" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="name_field_row">tTime:</td>
			<td class="field_row">
				<asp:TextBox id="txttTime" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
		...
		<tr>
			<td class="name_field_row">tTimeCheck:</td>
			<td class="field_row">
				<asp:TextBox id="txttTimeCheck" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lbltTimeCheck" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
			<td></td>
