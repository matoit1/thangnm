<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tblTagUI.aspx.cs" Inherits="Profile.tblTagUI" %>
...
FileTypeDownload="Excel" Width="100%" AllowPaging="True" datakeynames="PK_sTagID" 
...
<AlternatingRowStyle CssClass="GridAlternatingItem"></AlternatingRowStyle>
	<Columns>
		...
		<asp:BoundField  DataField="PK_sTagID"  HeaderText="PK_sTagID" SortExpression="PK_sTagID">
	...
	<asp:View ID="vDetail" runat="server" ><asp:LinkButton ID="lbtnBack" runat="server" onclick="lbtnBack_Click">Quay lại danh sách</asp:LinkButton><br />	<table id="tblDetail" style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
		...
		<tr>
			<td class="name_field_row">PK_sTagID:</td>
			<td class="field_row">
				<asp:TextBox id="txtPK_sTagID" runat="server" Width="200px"></asp:TextBox>
			</td>
			<td class="notify_fild_row">
				<asp:Label id="lblPK_sTagID" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
