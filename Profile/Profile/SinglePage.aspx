<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SinglePage.aspx.cs" Inherits="Profile.SinglePage" MasterPageFile="~/PublicInterface.Master" %>
	...
	<div class="container">
		<div class="main row">
			...
			<div class="details row">
				<div class="col-md-6">
					<img src="https://thangnm.googlecode.com/svn/profile/images/det_pic.jpg" alt="" class="img-responsive"/>
				</div>
				<div class="col-md-6">
			...
			<div class="read_more">
				<a href="SinglePage.aspx">read more</a>
			</div>
		</div>
	</div>
</div><!-- end main -->
