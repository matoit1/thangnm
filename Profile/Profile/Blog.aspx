<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blog.aspx.cs" Inherits="Profile.Blog" MasterPageFile="~/PublicInterface.Master"  %>
	...
	<div class="container">
		<div class="main row">
			<div class="col-md-8 blog_left">
				...
				<div class="blog_main">
					<a href="SinglePage.aspx"><img src="https://thangnm.googlecode.com/svn/profile/images/blog_pic1.jpg" alt="" class="blog_img img-responsive"/></a>
					<h4><a href="SinglePage.aspx">Lorem Ipsum is simply dummy text of the printingy </a></h4>
					...
					<div class="read_more btm">
						<a href="SinglePage.aspx">view more</a>
					</div>
				</div>
				<div class="blog_main">
					<iframe src="http://player.vimeo.com/video/25541923?color=c9161f" width="100%" height="350" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					<h4><a href="SinglePage.aspx">Lorem Ipsum is simply dummy text of the printingy </a></h4>
						<div class="blog_list pull-left">
							  <ul class="list-unstyled">
								<li><i class="fa fa-calendar-o"></i><span>June 3, 2013</span></li>
