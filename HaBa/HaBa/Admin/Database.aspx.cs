    ...
    public partial class Database : System.Web.UI.Page
    {
        ...
        protected void btnBackup_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LinkBackup = Server.MapPath(txtPath.Text + "/HaBa__" + Convert.ToString(DateTime.Now.ToString("dd-MM-yyyy__HH-mm-ss")) + ".bak");
                }
                else
                {
                    LinkBackup = txtPath.Text + "HaBa__" + Convert.ToString(DateTime.Now.ToString("dd-MM-yyyy__HH-mm-ss")) + ".bak";
                }
                string sqlBackup = "BACKUP DATABASE [HaBa] TO DISK='" + LinkBackup + "'";
        ...
        protected void btnRestore_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    string path = "D:\\backupHaBa.bak";
            //    string sqlRestore = "Use master Restore Database [HaBa] from disk='" + path + "'";
            //    SqlConnection conn = ConnectionDAO.getConnection();
            //    conn.Open();
