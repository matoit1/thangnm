...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div class="sortable row-fluid">
		...
		<a class="quick-button span2" href="../Admin/NhomSanPham.aspx?iTrangThai=1">
			<i class="icon-ok"></i>
			<p>Nhóm sản phẩm Mở</p>
			<span class="notification"><asp:Label ID="lblTongNhomSanPhamMo" runat="server"></asp:Label></span>
		</a>
		<a class="quick-button span2" href="../Admin/NhomSanPham.aspx?iTrangThai=2">
    ...
    <div class="sortable row-fluid">
		...
		<a class="quick-button span2" href="../Admin/SanPham.aspx?iTrangThai=1">
			<i class="icon-ok"></i>
			<p>Sản phẩm Mở</p>
			<span class="notification"><asp:Label ID="lblTongSanPhamMo" runat="server"></asp:Label></span>
		</a>
		<a class="quick-button span2" href="../Admin/SanPham.aspx?iTrangThai=2">
			<i class="icon-warning-sign"></i>
			<p>Sản phẩm Hết hàng</p>
			<span class="notification yellow"><asp:Label ID="lblTongSanPhamHetHang" runat="server"></asp:Label></span>
		</a>
		<a class="quick-button span2" href="../Admin/SanPham.aspx?iTrangThai=3">
			<i class="icon-remove"></i>
			<p>Sản phẩm Khóa</p>
    ...
    <div class="sortable row-fluid">
		...
		<a class="quick-button span2" href="../Admin/HoaDon.aspx?iTrangThai=1">
			<i class="icon-question-sign"></i>
			<p>Hóa đơn Chưa kiểm tra</p>
			<span class="notification"><asp:Label ID="lblTongHoaDonChuaKiemTra" runat="server"></asp:Label></span>
		</a>
		<a class="quick-button span2" href="../Admin/HoaDon.aspx?iTrangThai=2">
		...
		<a class="quick-button span2" href="../Admin/HoaDon.aspx?iTrangThai=3">
			<i class="icon-ok-sign"></i>
			<p>Hóa đơn Đã giao hàng</p>
			<span class="notification"><asp:Label ID="lblTongHoaDonDaGiaoHang" runat="server"></asp:Label></span>
		</a>
		<a class="quick-button span2" href="../Admin/HoaDon.aspx?iTrangThai=4">
