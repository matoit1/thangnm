...
namespace CongKy.SinhVien.Accounts
{
    public partial class Login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LoginUC1.hplRegister.NavigateUrl = "~/SinhVien/Accounts/Register.aspx";
        }
        ...
        protected void Login_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsInput = LoginUC1.Check(TaiKhoan_iQuyenHan_C.Sinh_Vien);
                if (dsInput.Tables[0].Rows.Count > 0)
                {
                    Response.Cookies["CongKy_sinhvien"].Value = LoginUC1.txtsTenDangNhap.Text;
                    if (LoginUC1.chkRememberMe.Checked == true)
                    {
                        Response.Cookies["CongKy_sinhvien"].Expires = DateTime.Now.AddDays(10);
                    }
                    else
                    {
