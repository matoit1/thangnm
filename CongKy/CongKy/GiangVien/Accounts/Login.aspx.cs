...
namespace CongKy.GiangVien.Accounts
{
    public partial class Login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LoginUC1.hplLost.NavigateUrl = "~/GiangVien/Accounts/ForgotPassword.aspx";
        ...
        protected void Login_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsInput = LoginUC1.Check(TaiKhoan_iQuyenHan_C.GiangVien);
                if (dsInput.Tables[0].Rows.Count > 0)   // 0. Đăng nhập thành công
                {
                    Response.Cookies["CongKy_giangvien"].Value = LoginUC1.txtsTenDangNhap.Text;
                    if (LoginUC1.chkRememberMe.Checked == true)
                    {
                        Response.Cookies["CongKy_giangvien"].Expires = DateTime.Now.AddDays(10);
                    }
                    else
                    {
