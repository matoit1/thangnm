<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonHoc.aspx.cs" Inherits="CongKy.GiangVien.MonHoc" MasterPageFile="~/ShareInterface/GiangVienSI.Master" %>
...
<%@ Register src="../UserControl/tblChiTietGiaoTrinh_DetailUC.ascx" tagname="tblChiTietGiaoTrinh_DetailUC" tagprefix="uc4" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <asp:MultiView ID="mtvMain" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="vDetail" runat="server">
            ...
            <cc1:TabPanel runat="server" HeaderText="Tải giáo trình lên" ID="tabUpload">
            <ContentTemplate>
                <uc4:tblChiTietGiaoTrinh_DetailUC ID="tblChiTietGiaoTrinh_DetailUC1" runat="server" />
            </ContentTemplate>
            </cc1:TabPanel>
        </cc1:TabContainer>
        </asp:View>
