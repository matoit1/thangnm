<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegisterUC.ascx.cs" Inherits="CongKy.UserControl.RegisterUC" %>
<asp:ScriptManager ID="ScriptManager1" runat="server">
</asp:ScriptManager>
<table>
    <tr>
        <td></td>
        <td><center><h2><asp:Label ID="lblTitle" runat="server" Text="Đăng ký tài khoản - CongKy" ForeColor="Blue"></asp:Label></h2></center></td>
        <td></td>
    </tr>
    <tr>
        <td></td>
