<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting.aspx.cs" Inherits="ThangNMjsc.Admin.Setting" MasterPageFile="~/MasterPage/PublicAdmin.Master"%>
...
<asp:Content ID="Content" ContentPlaceHolderID="cphMainContent_Admin" runat="server">
    ...
    <div>
        <center><asp:Label ID="Label8" runat="server" Text="Cài đặt và các bài viết" CssClass="tieude"></asp:Label><br /><br />
        <asp:Label ID="Label13" runat="server" style="margin-left:50px"></asp:Label>
        </center>
        <cc1:GridViewExt ID="grvListSetting" runat="server" CssClass="mGrid" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"
                FileTypeDownload="Excel" Width="100%" AllowPaging="True" PageSize="15" DataKeyNames="Website_ID"
                classCheckedRow="" classHoverRow="" ColumnShowOnclick="" EnableModelValidation="True"
                WidthCheckBoxColumn="50" emptydatatext="Không có dữ liệu trả về."  onrowdatabound="grvListSetting_RowDataBound" onpageindexchanging="grvListSetting_PageIndexChanging">
            ...
            <columns>
                ...
                <asp:BoundField DataField="Website_ID" HeaderText="Mã số">
                    <ItemStyle CssClass="GridItemText" />
                </asp:BoundField>
                <asp:BoundField DataField="Website_Title" HeaderText="Tiêu đề">
                    <ItemStyle CssClass="GridItemText" />
                </asp:BoundField>
                <asp:BoundField DataField="Website_LastUpdate" HeaderText="Cập nhật lần cuối" DataFormatString="{0:dd/MM/yyyy HH:mm}">
                    <ItemStyle CssClass="GridItemDate" />
                </asp:BoundField>
            </columns>
        </cc1:gridviewext>
        <br /><hr />
        <asp:Button ID="Delete" runat="server" Text="Xóa" onclick="btnDelete_Click" OnClientClick="return confirm('Bạn có muốn xóa những khách hàng đã chọn ko?');" />
        <asp:Button ID="Button1" runat="server" Text="Thêm bài viết mới" PostBackUrl="~/Admin/Edit/EditSetting.aspx" />
    </div>
</asp:Content>