<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Support.aspx.cs" Inherits="ThangNMjsc.Admin.Support" MasterPageFile="~/MasterPage/PublicAdmin.Master"%>
...
<asp:Content ID="Content" ContentPlaceHolderID="cphMainContent_Admin" runat="server">
    ...
    <div>
        <center><asp:Label ID="Label8" runat="server" Text="Tất cả các Hỗ trợ của Khách hàng đã được xử lý" CssClass="tieude"></asp:Label><br /><br />
        <asp:Label ID="Label13" runat="server" style="margin-left:50px"></asp:Label>
        </center>
        <cc1:gridviewext id="grvListSupport" runat="server" cssclass="mGrid" autogeneratecheckboxcolumn="True"
