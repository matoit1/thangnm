<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="ThangNMjsc.Admin.Orders" MasterPageFile="~/MasterPage/PublicAdmin.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="cphMainContent_Admin" runat="server">
    ...
    <div>
        <center><asp:Label ID="Label8" runat="server" Text="Tất cả các Hóa đơn đã được xử lý" CssClass="tieude"></asp:Label><br /><br />
