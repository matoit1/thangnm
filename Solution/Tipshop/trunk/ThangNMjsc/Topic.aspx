<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Topic.aspx.cs" Inherits="ThangNMjsc.Topic" MasterPageFile="~/MasterPage/PublicProduct.Master"%>
    ...
    <div style="margin: 15px 15px 15px 15px;">
        ...
        <center><br /><br /><h1><asp:Label ID="lblMore" runat="server"></asp:Label></h1><br /></center>
            <asp:Repeater ID="rpTopic" runat="server" onitemcommand="rpTopic_ItemCommand">
                ...
                <ItemTemplate>
                    <li><asp:HiddenField ID="lblWebsite_ID" runat="server" Value='<%#Eval("Website_ID")%>'></asp:HiddenField>
                        <asp:Label ID="Label1" runat="server" Text="Tiêu đề: "></asp:Label>
                        <asp:Label ID="lblWebsite_Title" runat="server" Text='<%#Eval("Website_Title")%>'></asp:Label>
                        <i><asp:Label ID="lblWebsite_LastUpdate" runat="server" Text='<%#" cập nhật lần cuối: <"+Eval("Website_LastUpdate")+">"%>'></asp:Label></i>
