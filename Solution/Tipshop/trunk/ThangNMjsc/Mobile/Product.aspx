<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ThangNMjsc.Mobile.Product" MasterPageFile="~/Mobile/Mobile.Master" %>

<asp:Content ID="Content2" ContentPlaceHolderID="cphHead_Mobile" runat="server">
    <title>Sản phẩm - ThangNM Join Stock Company</title>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMainContent_Mobile" runat="server">
    <div class="article">
        <h1 class="article-title"><asp:Label ID="lblProducts_Name" runat="server" ></asp:Label></h1>
        ...
        <div class="pBody">
            <div class="detail">
                <p><strong><asp:Label ID="Label3" runat="server" ></asp:Label></strong><br />
        ...
        <ul data-role="listview" data-inset="true" data-theme="d" data-divider-theme="e" data-count-theme="b">
            ...
            <asp:DataList ID="DataList1" runat="server" RepeatColumns="1" DataKeyField="Products_ID" DataSourceID="SqlDataSource1" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                <li>
