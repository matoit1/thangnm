...
namespace ThangNMjsc.Test
{
    public partial class DataList : System.Web.UI.Page
    {
        ...
        protected void rpListProductGroup_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            DataList dtlDemo = (DataList)e.Item.FindControl("dtlDemo");
            if ((hrId != null) && (dtlDemo != null))
            {
        ...
        protected void dtlDemo_ItemCommand(object source, DataListCommandEventArgs e)
        {
