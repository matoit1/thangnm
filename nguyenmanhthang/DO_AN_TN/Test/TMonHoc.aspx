<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMonHoc.aspx.cs" Inherits="DO_AN_TN.Test.TMonHoc" MasterPageFile="~/Share_Interface/Test.Master"  EnableEventValidation="false" %>
...
<asp:Content ID="cContent" runat="server" ContentPlaceHolderID="cphBody">
    <asp:MultiView ID="mtvMain" runat="server" ActiveViewIndex="0">
        <asp:View ID="vList" runat="server">
            <uc2:MonHoc_ListUC ID="MonHoc_ListUC1" runat="server" OnSelectRow="SelectRow_Click" OnViewDetail="ViewDetail_Click" OnAddNew="AddNew_Click"/>
        </asp:View>
