        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnReset">
                <div class="signin-card">
                    <asp:ImageButton ID="imgProfile" CssClass="profile-img" ImageUrl="~/Images/Avatar/default.jpg" AlternateText="ThangNM" PostBackUrl="~/Default.aspx" runat="server" />
...
<br />
                    ...
                    <br /><asp:TextBox ID="txtCaptcha1" runat="server" placeholder="Captcha" ></asp:TextBox>
