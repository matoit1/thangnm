<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LopHoc_SearchUC.ascx.cs" Inherits="DO_AN_TN.UserControl.Search.LopHoc_SearchUC" %>
<div id="toPopup">
	<div class="close"></div>
	...
	<div id="popup_content">
        <asp:Panel ID="Panel1" runat="server" CssClass="wrap" DefaultButton="btnSearch">
            <table>
                <tr>
                    <td colspan="2" class="title">Tìm kiếm lớp học</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
