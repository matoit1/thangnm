<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BaiViet_SearchUC.ascx.cs" Inherits="DO_AN_TN.UserControl.Search.BaiViet_SearchUC" %>
<div id="toPopup">
	<div class="close"></div>
	...
	<div id="popup_content">
        <asp:Panel ID="Panel1" runat="server" CssClass="wrap" DefaultButton="btnSearch">
            <table>
                <tr>
                    <td colspan="2" class="title">Tìm kiếm bài viết</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
