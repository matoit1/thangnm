...
<asp:Panel ID="pnlLogin" runat="server" DefaultButton="btnLogin">
    <div class="signin-card">
        <asp:ImageButton ID="imgProfile" CssClass="profile-img" ImageUrl="~/Images/Avatar/admin.jpg" AlternateText="ThangNM" PostBackUrl="~/Default.aspx" runat="server" />
        <br />
	    ...
	    <span>Ghi nhớ</span>
        <asp:HyperLink ID="hplLost" runat="server" NavigateUrl="~/Accounts/ForgotPassword.aspx">Quên Tài khoản / Mật khẩu?</asp:HyperLink>
        <a id="A1" href=""></a><br /><br />
