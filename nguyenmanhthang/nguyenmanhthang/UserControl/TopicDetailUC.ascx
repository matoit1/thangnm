<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopicDetailUC.ascx.cs" Inherits="nguyenmanhthang.UserControl.TopicDetailUC" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:UpdatePanel ID="updatePanelTopicDetailUC" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div class="clear"></div>
