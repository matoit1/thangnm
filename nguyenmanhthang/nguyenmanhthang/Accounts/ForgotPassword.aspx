<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="nguyenmanhthang.Accounts.ForgotPassword" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnReset">
                <div class="signin-card">
                    ...
                    <asp:TextBox ID="txtAccounts_Email" name="Email" type="email" placeholder="Email đăng ký" spellcheck="false" runat="server"></asp:TextBox><br />
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel2" runat="server" DefaultButton="btnFindAccount">
                <div class="signin-card">
                    ...
                    <asp:TextBox ID="txtAccounts_PhoneNumber" name="PhoneNumber" type="tel" placeholder="Số điện thoại đăng ký" spellcheck="false" runat="server"></asp:TextBox><br />
