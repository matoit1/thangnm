<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MonHoc_DetailUC.ascx.cs" Inherits="EHOU.UserControl.MonHoc_DetailUC" %>
<div>
    <table>
        <tr>
            <td></td>
        ...
        <tr>
            <td>Mã môn học: </td>
            <td><asp:TextBox ID="txtPK_sMaMonhoc" runat="server" Width="400px" ontextchanged="txtsTenMonhoc_TextChanged" AutoPostBack="true"></asp:TextBox></td>
            <td><asp:Label ID="lblPK_sMaMonhoc" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td>Tên môn học: </td>
            <td><asp:TextBox ID="txtsTenMonhoc" runat="server" Width="400px" ontextchanged="txtsTenMonhoc_TextChanged" AutoPostBack="true"></asp:TextBox></td>
