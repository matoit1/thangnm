<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tblAccount_ListUC.ascx.cs" Inherits="EHOU.UserControl.tblAccount_ListUC" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="grvListBaiViet" runat="server" CssClass="mGrid" 
                    ...
                    FileTypeDownload="Excel" Width="100%" AllowPaging="True" datakeynames="PK_sUsername"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="cmdDetail" runat="server" CommandName="cmdView" Width="90px" CommandArgument='<%#Eval("PK_sUsername")%>'>Chi tiết</asp:LinkButton>
                                </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center"  />
                        </asp:TemplateField>
                        <asp:BoundField  DataField="PK_sUsername"  HeaderText="Tên đăng nhập" SortExpression="PK_sUsername">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField  DataField="sPassword"  HeaderText="Mật khẩu" SortExpression="sPassword">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField DataField="sName" HeaderText="Họ và Tên" SortExpression="sName">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
                        <asp:BoundField DataField="sEmail" HeaderText="Địa chỉ Email" SortExpression="sEmail">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
                        <asp:BoundField DataField="iType" HeaderText="Loại người dùng" SortExpression="iType">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
