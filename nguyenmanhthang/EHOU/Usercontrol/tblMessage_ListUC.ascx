<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tblMessage_ListUC.ascx.cs" Inherits="EHOU.UserControl.tblMessage_ListUC" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="grvListBaiViet" runat="server" CssClass="mGrid" 
                    ...
                    FileTypeDownload="Excel" Width="100%" AllowPaging="True" datakeynames="PK_lMessage"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="cmdDetail" runat="server" CommandName="cmdView" Width="90px" CommandArgument='<%#Eval("PK_lMessage")%>'>Chi tiết</asp:LinkButton>
                                </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center"  />
                        </asp:TemplateField>
                        <asp:BoundField  DataField="PK_lMessage"  HeaderText="Mã tin nhắn" SortExpression="PK_lMessage">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField  DataField="FK_sRoom"  HeaderText="Phòng chat" SortExpression="FK_sRoom">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField DataField="FK_sUsername" HeaderText="Người gửi" SortExpression="FK_sUsername">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
                        <asp:BoundField DataField="sContent" HeaderText="Nội dung" SortExpression="sContent">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
                        <asp:BoundField DataField="tDateSent" HeaderText="Ngày gửi" SortExpression="tDateSent">
                            <ItemStyle CssClass="GridItemText" />
                        </asp:BoundField>
