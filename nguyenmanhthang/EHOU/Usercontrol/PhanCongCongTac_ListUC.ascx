<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhanCongCongTac_ListUC.ascx.cs" Inherits="EHOU.UserControl.PhanCongCongTac_ListUC" %>
<%@ Register src="Search/PhanCongCongTac_SearchUC.ascx" tagname="PhanCongCongTac_SearchUC" tagprefix="uc1" %>
...
<div>
            ...
            <td>
                <asp:Panel ID="pnlSearch" runat="server" Visible="true">
                        ...
                        <asp:DropDownList ID="ddlTypeSearch" runat="server" ontextchanged="ddlTypeSearch_TextChanged">
                            ...
                            <asp:ListItem Value="1">Tìm theo mã GV</asp:ListItem>
                        </asp:DropDownList>
    ...
    <uc1:PhanCongCongTac_SearchUC ID="PhanCongCongTac_SearchUC1" runat="server" OnSearch="Search_Click" />
</div>
