<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhanCongCongTac_DetailUC.ascx.cs" Inherits="EHOU.UserControl.PhanCongCongTac_DetailUC" %>
...
<div>
    <table>
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtPK_sMaPCCT" runat="server" Width="400px" ontextchanged="txtPK_sMaPCCT_TextChanged" AutoPostBack="true"></asp:TextBox></td>
