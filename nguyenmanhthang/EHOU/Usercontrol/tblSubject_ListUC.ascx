<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tblSubject_ListUC.ascx.cs" Inherits="EHOU.UserControl.tblSubject_ListUC" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="grvListBaiViet" runat="server" CssClass="mGrid" 
                    ...
                    FileTypeDownload="Excel" Width="100%" AllowPaging="True" datakeynames="PK_sSubject"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="cmdDetail" runat="server" CommandName="cmdView" Width="90px" CommandArgument='<%#Eval("PK_sSubject")%>'>Chi tiết</asp:LinkButton>
                                </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center"  />
                        </asp:TemplateField>
                        <asp:BoundField  DataField="PK_sSubject"  HeaderText="Mã Môn học" SortExpression="PK_sSubject">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField  DataField="FK_sTeacher"  HeaderText="Giảng viên dạy" SortExpression="FK_sTeacher">
                            <ItemStyle Wrap="true" CssClass="GridItemNumber"/>
                        </asp:BoundField>
                        <asp:BoundField DataField="sName" HeaderText="Tên Môn học" SortExpression="sName">
