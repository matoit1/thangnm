<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HocTap.aspx.cs" Inherits="EHOU.SinhVien.HocTap" MasterPageFile="~/Share_Interface/SinhVien_SI.Master" %>
...
<asp:Content ID="cContent" runat="server" ContentPlaceHolderID="cphBody">
    ...
    <div class="ebook">
        <asp:UpdatePanel ID="udpSync" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Timer ID="tSync" runat="server" ontick="tSync_Tick"></asp:Timer>
