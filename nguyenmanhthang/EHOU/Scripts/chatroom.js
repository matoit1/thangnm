// JScript File
			...
			function updateUser()
			{
			    PageMethods.UpdateUser(window.GetQueryString("hdnRoomID"), UpdateMessages);
			}
			function updateMembers()
			{
			    PageMethods.UpdateRoomMembers(window.getParameterByName("hdnRoomID"), UpdateMembersList);
			}
			function Leave()
			{
			    stopTimers();
			    PageMethods.LeaveRoom(window.GetQueryString("hdnRoomID").value);
			}
			function button_clicked()
			{
			    PageMethods.SendMessage($get("txtMsg").value, window.GetQueryString("hdnRoomID"), UpdateMessages, errorCallback);
				$get("txtMsg").value="";
