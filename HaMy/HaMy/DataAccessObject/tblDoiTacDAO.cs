        ...
        public static DataSet DoiTac_Search(tblDoiTacEO _tblDoiTacEO)
        {
            ...
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                try
                {
                    ...
                    da.SelectCommand.CommandType = CommandType.StoredProcedure;
                    da.SelectCommand.Parameters.Add(new SqlParameter("@FK_iNhom", _tblDoiTacEO.FK_iNhom));              
                    da.SelectCommand.Parameters.Add(new SqlParameter("@PK_iDoiTac", _tblDoiTacEO.PK_iDoiTac));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sHoTen", _tblDoiTacEO.sHoTen));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sDiaChi", _tblDoiTacEO.sDiaChi));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sEmail", _tblDoiTacEO.sEmail));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sSoDienThoai", _tblDoiTacEO.sSoDienThoai));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@tNgaySinh", _tblDoiTacEO.tNgaySinh));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@bGioiTinh", _tblDoiTacEO.bGioiTinh));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sNgheNghiep", _tblDoiTacEO.sNgheNghiep));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@FK_iMoiQuanHe", _tblDoiTacEO.FK_iMoiQuanHe));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sGhiChu", _tblDoiTacEO.sGhiChu));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@iTrangThai", _tblDoiTacEO.iTrangThai));
                    dsOutput = new DataSet();
                    da.Fill(dsOutput);
                    conn.Close();
                    return dsOutput;
