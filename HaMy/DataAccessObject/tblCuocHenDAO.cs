...
namespace HaMy.DataAccessObject
{
    public class tblCuocHenDAO
    {
        ...
        /// <summary> 8. CuocHen_SelectList_Notifycation </summary>
        /// <param name="_tblCuocHenEO"></param>
        /// <returns></returns>
        public static DataSet CuocHen_SelectList_Notifycation()
        {
            DataSet dsOutput = null;
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                ...
                {
                    conn.Open();
                    SqlDataAdapter da = new SqlDataAdapter("tblCuocHen_SelectList_Notifycation", conn);
                    da.SelectCommand.CommandType = CommandType.StoredProcedure;
                    dsOutput = new DataSet();
                    da.Fill(dsOutput);
                    conn.Close();
        ...
        public static DataSet CuocHen_Search(tblCuocHenEO _tblCuocHenEO)
        {
            ...
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                try
                {
                    ...
                    da.SelectCommand.CommandType = CommandType.StoredProcedure;
                    da.SelectCommand.Parameters.Add(new SqlParameter("@PK_lCuocHen", (_tblCuocHenEO.PK_lCuocHen == 0) ? (object)DBNull.Value : _tblCuocHenEO.PK_lCuocHen));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@FK_iNguoiDung", (_tblCuocHenEO.FK_iNguoiDung == 0) ? (object)DBNull.Value : _tblCuocHenEO.FK_iNguoiDung));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@FK_iDoiTac", (_tblCuocHenEO.FK_iDoiTac == 0) ? (object)DBNull.Value : _tblCuocHenEO.FK_iDoiTac));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sNoiDung", (String.IsNullOrEmpty(_tblCuocHenEO.sNoiDung)) ? (object)DBNull.Value : _tblCuocHenEO.sNoiDung));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@sDiaDiem", (String.IsNullOrEmpty(_tblCuocHenEO.sDiaDiem)) ? (object)DBNull.Value : _tblCuocHenEO.sDiaDiem));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@tNgayGioBatDau", (_tblCuocHenEO.tNgayGioBatDau == DateTime.MinValue) ? (object)DBNull.Value : _tblCuocHenEO.tNgayGioBatDau));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@tNgayGioKetThuc", (_tblCuocHenEO.tNgayGioKetThuc == DateTime.MinValue) ? (object)DBNull.Value : _tblCuocHenEO.tNgayGioKetThuc));
                    da.SelectCommand.Parameters.Add(new SqlParameter("@iTrangThai", (_tblCuocHenEO.iTrangThai == 0) ? (object)DBNull.Value : _tblCuocHenEO.iTrangThai));
                    dsOutput = new DataSet();
                    da.Fill(dsOutput);
                    conn.Close();
                    return dsOutput;
