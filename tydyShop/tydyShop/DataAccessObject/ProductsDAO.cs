...
namespace DataAccessObject
{
    public class ProductsDAO
    {
        ...
        public static bool setInsertGroupProducts(ProductsEO _ProductsEO)
        {
        ...
        public static bool setInsertProducts(ProductsEO _ProductsEO)
        {
        ...
        public static bool setUpdateGroupProducts(ProductsEO _ProductsEO)
        {
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                try
        ...
        public static bool setUpdateProducts(ProductsEO _ProductsEO)
        {
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                try
        ...
        public static DataSet Products_SelectItem(ProductsEO _ProductsEO)
        {
            DataSet ds = null;
            using (SqlConnection conn = ConnectionDAO.getConnection())
            {
                ...
                {
                    conn.Open();
                    SqlDataAdapter da = new SqlDataAdapter("Products_SelectItem", conn);
                    da.SelectCommand.CommandType = CommandType.StoredProcedure;
                    da.SelectCommand.Parameters.Add(new SqlParameter("@Products_ID", _ProductsEO.Products_ID));
                    ds = new DataSet();
                    da.Fill(ds);
                    conn.Close();
                    return ds;
