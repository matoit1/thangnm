...
namespace HaMy
{
    public partial class frmCuocHen : Form
    {
        ...
        public void BindDataDetail(tblCuocHenEO _tblCuocHenEO)
        {
            ...
            dpktNgayGioBatDauTime.Text = (_tblCuocHenEO.tNgayGioBatDau == DateTime.MinValue) ? DateTime.Now.ToString() : Convert.ToString(_tblCuocHenEO.tNgayGioBatDau);
            dpktNgayGioKetThucTime.Text = (_tblCuocHenEO.tNgayGioKetThuc == DateTime.MinValue) ? DateTime.Now.ToString() : Convert.ToString(_tblCuocHenEO.tNgayGioKetThuc);
        ...
        public bool CheckInput()
        {
            ...
            DateTime tNgayGioBatDau = Convert.ToDateTime(dpktNgayGioBatDauDate.Value.ToShortDateString() + " " + dpktNgayGioBatDauTime.Value.ToShortTimeString());
            DateTime tNgayGioKetThuc = Convert.ToDateTime(dpktNgayGioKetThucDate.Value.ToShortDateString() + " " + dpktNgayGioKetThucTime.Value.ToShortTimeString());

            if ((tNgayGioKetThuc - tNgayGioBatDau).TotalSeconds < 0)
            {
                lbltNgayGioBatDau.Text = Messages.Bat_Dau_Ket_Thuc;
                dpktNgayGioBatDauDate.Focus();
                return false;
            }
            return true;
        }
